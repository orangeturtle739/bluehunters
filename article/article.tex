...
\begin{figure}
  \centering
  \subfloat[Top view]{
    \includegraphics[width=0.4\textwidth]{top_view.jpg}
    \label{fig:robottop}
  }
  \subfloat[Side view]{
    \includegraphics[width=0.4\textwidth]{side_view.jpg}
    \label{fig:robotside}
  }
  \\
  \subfloat[Front view]{
    \includegraphics[width=0.4\textwidth]{front_view.jpg}
    \label{fig:robotfront}
  }
  \subfloat[Back view]{
    \includegraphics[width=0.4\textwidth]{inside_view.jpg}
    \label{fig:robotback}
  }
