...
report/report.html: README.md report/GitHub.html5 report/frame.png report/drag.png report/wheel.png | report
	pandoc README.md --template report/GitHub.html5 --self-contained --toc --toc-depth 3 -r markdown+yaml_metadata_block -t html -s -o report/report.html
