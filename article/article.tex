...
The robots themselves are made from 4 3D printed pieces: 2 wheels, the frame, and
...
The HM-10 bluetooth modules we bought off Ebay were fakes: they were not made by Jnhuamao \cite{jnhuamao}, the manufacturer of the HM-10 module we intended to use. The modules we bought did not come with genuine Jnhuamao firmware.
